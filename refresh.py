...
url_PA = 'https://greg-incogneato.imfast.io/PA_election_night_raw_data_extract.xml'
...
def update_FL(input_url):
    ...
    #     election_night_data_FL.to_excel(writer)
    #   data = output.getvalue()
    # s3.Bucket('en2020').put_object(Key=archive_file_name, Body=data)
...
def update_PA(input_url):
    ...
    #     f.write(resp.content) 
    # s3.Bucket('en2020').put_object(Key=archive_file_name, Body=resp.content)
